...
class SiweMessageParams
{
     ...
     * @param string|null      $issuedAt       The time when the message was generated, typically the current time. Default: now
     ...
     * @param string|null      $expirationTime The time when the signed authentication message is no longer valid
     * @param string|null      $notBefore      The time when the signed authentication message will become valid
